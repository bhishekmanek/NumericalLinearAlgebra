...
! 13. rms_error - Calculates rms error for the fitted curve and input data 
! 14. plot_dat - Stores the fitted polynomial in a file "plot.dat" 
! 15. error_mat - Calculates error matrix E = AX - B 
...
!   write(*,*)"Eigenvector matrix at iteration step", iter_count  
!   do i=1,msize
!      write(*,*)(matV(i,j),j=1,nsize)
!   enddo

!   e_value1 = matmul(matmul(transpose(q_mat),Asave),q_mat)
!   write(*,*)"Eigenvalues at iteration step", iter_count
!   do i=1,msize
!      print*,evalue(i)
!   enddo
   
!   print*,"Error in eigenvalues: ", error
!   write(*,*)" " 
